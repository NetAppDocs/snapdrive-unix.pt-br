...
* Se você especificar `autorename` a opção com o comando snap connect, os volumes de host e os sistemas de arquivos serão sempre renomeados. Os grupos de discos são renomeados somente se já existirem no host.
