...
* Se você estiver usando o ambiente SAN, certifique-se de que os valores aceitáveis apropriados sejam especificados no `snapdrive.conf` arquivo, conforme fornecido na pilha de matriz Solaris. Em seguida, reinicie o daemon.
